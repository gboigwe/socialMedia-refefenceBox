  ...
  return (
    ...
    >
      <form className="infoForm" >
        ...
        <div>
          <input value={formData.worksAt} onChange={handleChange} type="text" className="infoInput" name="worksAt" placeholder="Works at" />
        </div>

        <div>
          <input type="text" className="infoInput" name="livesin" placeholder="Lives in " onChange={handleChange} value={formData.livesin} />
          <input type="text" className="infoInput" name="country" placeholder="Country" value={formData.country} />
        </div>

        <div>
          <input type="text" className="infoInput" name="relationship" placeholder="Level Status" onChange={handleChange} value={formData.relationship} />
        </div>
        ...
        <button className="button infoButton" onClick={handleSubmit} >Save</button>
      </form>
    </Modal>
  )
}
